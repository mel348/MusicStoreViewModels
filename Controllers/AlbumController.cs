...
namespace MusicStore.Controllers
{
    public class AlbumController : Controller
    {
        ...
        {
            var data = new ArtistViewModel              //object for our new model
            {
                Album = _context.Albums.ToList(),       //accessing the database and grabbing all the albums, putting them in a list, and storing them in the album property. 
                Artist = _context.Artists.ToList()      //same as albums only for artists.
            };
            return View(data);
        }
